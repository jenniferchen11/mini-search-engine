 ...
 private int testNumEdges(int testIdx) //Test num of edges added during crawl and index. Uses testAcyclic.xml
 {
  ...
  try {
   ...
   if(numEdges == 4)
    ...
    comment = comment + numEdges + " Error: Number of edges added during crawling is incorrect.\n";
    grade = 0;
   }
   write(gradeString(grade, maxScore, comment));
  }
...
//  g.write(g.gradeString(total, 50, ""));
     ...
     SearchEngine se = new SearchEngine("test1.xml");
     se.crawlAndIndex("siteA");
     se.assignPageRanks(0.001);
     System.out.println(se.internet.getPageRank("siteA"));
     System.out.println(se.internet.getPageRank("siteD"));
     System.out.println(se.internet.getPageRank("siteC"));
     System.out.println(se.internet.getPageRank("siteE"));
     se.crawlAndIndex("siteB");
     se.assignPageRanks(0.001);
     System.out.println();
     System.out.println(se.internet.getPageRank("siteA"));
     System.out.println(se.internet.getPageRank("siteD"));
     System.out.println(se.internet.getPageRank("siteC"));
     System.out.println(se.internet.getPageRank("siteE"));
     System.out.println(se.internet.getPageRank("siteB"));
